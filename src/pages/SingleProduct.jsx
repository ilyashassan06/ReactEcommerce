...
const { addToCart } = useContext(CartContext);
  ...
  return (
    <>
     <div className={`max-w-6xl mx-auto rounded-2xl my-12 p-4 grid grid-cols-1 md:grid-cols-2 gap-10 ${theme === "light"
 ? "bg-gray-100 text-black"
      ...
      <div className={`flex flex-col  gap-6  ${theme === "light"
 ? "bg-gray-100 text-black"
      : "bg-[#181818] text-white"
    }`}>
        <div>
        ...
        <div className={`border rounded-xl p-4 mt-2 flex flex-col gap-3  ${theme === "light"
 ? "bg-gray-100 text-black"
      : "bg-[#181818] text-white"
    }`}>
