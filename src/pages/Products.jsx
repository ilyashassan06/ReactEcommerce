  ...
  return (
    <div className="w-full min-h-screen flex flex-col lg:flex-row px-4 py-4 lg:px-10">
      ...
      <div className="flex-1">
       <div className="flex flex-wrap justify-center gap-1 md:gap-6 w-[100%] px-0 sm:px-4">

          {filteredProducts.map((product, index) => (
             <div key={product.id || index} className=" flex flex-shrink-0 justify-center  text-xl w-[49%]  md:w-65">
            <Card
