...
function CardsSlider() {
  ...
  return (
    <div className="flex w-full overflow-x-auto overflow-y-hidden gap-4 p-4">
      ...
      // amount:0.3 → triggers when 30% is visible
          ...
          // animate={{ scale: 1 }}
          // transition={{
          //   duration: 1, // ⏳ animation runs for 1.5s
          //   ease: "easeInOut", // optional easing
          // }}
          key={product.id || index}
          className="flex-shrink-0 w-70 text-lg sm:w-[250px] md:w-[250px]"
        >
